...
public final class PawnsBoardGame {
  ...
  public static void main(String[] args) throws IOException {
    PawnsBoardBuilder builder = new PawnsBoardBuilder(5, 7);
    String p1DeckPath = "";
    String p2DeckPath = "";
    String player1Type = "";
    String player2Type = "";
    ...
    try {
      ...
      List<GameCard> p1Deck = deckConfig.loadDeckConfig(new FileReader(p1config));
      List<GameCard> p2Deck = deckConfig.loadDeckConfig(new FileReader(p2config));
