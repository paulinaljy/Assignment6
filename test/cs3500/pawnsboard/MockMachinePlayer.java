...
/**
 * Represents a mock of the machine player used to test that the machines are taking turns correctly.
 */
public class MockMachinePlayer implements GamePlayer {
   ...
   */
  public MockMachinePlayer(ReadonlyPawnsBoardModel model, Strategy strategy, int playerID, StringBuilder log) {
    this.model = model;
